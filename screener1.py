...
filePath = r"C:\DISHA\3rd sem internship\Task2\StockScreener\EXstocks.xlsx"
...
newFile ="C:/DISHA/3rd sem internship/Task2/StockScreener/ScreenOutput.xlsx"

exportList.to_excel(newFile, index=False, sheet_name="Sheet1", engine='openpyxl')
